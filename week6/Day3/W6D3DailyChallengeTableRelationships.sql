...
-- 	stud_age SMALLINT NOT NULL CONSTRAINT age_check CHECK (stud_age <= 15)  ----> MORE EFFICIENT THAN stud_age SMALLINT NOT NULL DEFAULT 15
-- );
...
--------------- Query: List students and the books they borrowed
...
--------------- Query: Calculate average age of students who borrowed 'Alice In Wonderland'
